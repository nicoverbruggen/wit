...
import { createProjectTreeStateController } from "../project/tree/state.js";
import { createEntryDialogController } from "../project/tree/entry-dialog.js";
import { createProjectEntryActionsController } from "../project/tree/entry-actions.js";
import { createLiveWordCountTracker } from "../editor/live-word-count.js";
import { createEditorInteractionsController } from "../editor/interactions.js";
import { createEditorPresentationController } from "../editor/presentation.js";
import { createEditorDirtyStateController } from "../editor/dirty-state.js";
import { createFileSessionController } from "../editor/file-session.js";
import { createTypingActivityTracker } from "../editor/typing-activity.js";
import { createAutosaveController } from "../autosave/autosave.js";
import { createSnapshotLabelController } from "../autosave/snapshot-label.js";
import { createSidebarController } from "../shell/sidebar.js";
import { createSidebarUiController } from "../shell/sidebar-ui.js";
import { createAppShellUiController } from "../shell/ui.js";
import { createSettingsDialogController } from "../settings/dialog.js";
import { createProjectUiController } from "../project/ui.js";
import { createProjectLifecycleController } from "../project/lifecycle.js";
import { createProjectPersistenceController } from "../project/persistence.js";
import { createProjectStateApplicationController } from "../project/apply-metadata.js";
import { createEmptyEditorStateController } from "../project/empty-editor-state.js";
...
export function createRendererComposition(options: {
  ...
  callbacks: RendererCompositionCallbacks;
  formatting: {
  ...
  const entryDialogController = createEntryDialogController({
    ...
    newFilePreview: options.dom.newFilePreview,
    ...
    newFolderPreview: options.dom.newFolderPreview,
  ...
  const projectUiController = createProjectUiController({
    ...
    applyEditorCursorStyle: options.callbacks.applyEditorCursorStyle,
